...
<div style="height:100px; border:solid 1px #cccccc; margin: 5px; padding-top: 10px;">
	<table style="width: 98%;">
		...
		<tr>
			...
			<td width="23%"><input type="text" id="listCountry" /><input type="hidden" id="country_id" /><input type="hidden" id="country_name" /></td>
			<td width="10%" align="right">省份：</td>
			<td width="23%"><input type="text" id="listProvince" /><input type="hidden" id="province_id" /><input type="hidden" id="province_name" /></td>
			<td width="10%" align="right">城市：</td>
			<td><input type="text" id="listCity" /><input type="hidden" id="city_id" /><input type="hidden" id="city_name" /></td>
		</tr>
		<tr>
			<td colspan="6" align="right" height="30">
				...
				<input value="测试" type="button" onclick="textListPro()" class="ctbt-btn"/>
			</td>
		</tr>
	</table>
</div>
